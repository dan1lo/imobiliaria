...
$q1 = "select * from re2_listings, re2_agents, re2_priority where re2_listings.AgentID = re2_agents.AgentID and re2_agents.PriorityLevel = re2_priority.PriorityLevel and re2_agents.AccountStatus = 'active' order by RAND() limit 9 ";
...
if($lrows > '0')
{
	...
	while($a1 = mysql_fetch_array($r1))
	{
		...
		$TopTable .= "<td width=80>$a1[rooms] quarto(s), $a1[bathrooms] banheiro(s)";
