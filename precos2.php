...
{
	$NewAgentMessage = "<font face=verdana color=black size=2><b>Obrigado por se cadastrar!</b><br><font size=1>Você agora já pode cadastrar seus anúncios!<br><br>";
}

//get the templates
require_once("templates/HeaderTemplate.php");
require_once("templates/Prices2Template.php");
