...
if(isset($_POST[ss1]))
{
	...
	echo "<br><center>As informações foram atualizadas com sucesso!<br>Clique <a class=RedLink href=\"CategoriesDelete.php?CategoryID=$_GET[CategoryID]&n=0\">AQUI</a> para deletar esta categoria.</center>";
