...
$q1 = "select * from re2_agents where AccountStatus = 'active'  order by FirstName ";
$r1 = mysql_query($q1) or die(mysql_error());

if(mysql_num_rows($r1) == '0')
{
	echo "<br><br><center><font color=red size=2 face=verdana><b>Não existem agentes ativos!</b></font></center>";
	exit();
}
...
<caption align=center><b>Agentes ativos</b></caption>
<tr>
